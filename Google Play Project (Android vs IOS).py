...
#our peers have informed us that row 10472 is missing information, and we would like to detect this row and check, function below finds rowss that don't 
#have the same number of items as the header, and we would like to compare this row to a normal row and the header
for row in android:
